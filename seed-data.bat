...
REM =========================
set "API_URL=http://localhost:55000"
set "BASIC_USER=admin"
set "BASIC_PASS=password"

REM Build: Basic base64(user:pass)
for /f "usebackq delims=" %%A in (`powershell -NoProfile -Command ^
  "[Convert]::ToBase64String([Text.Encoding]::UTF8.GetBytes('%BASIC_USER%:%BASIC_PASS%'))"`) do set "BASIC_B64=%%A"
set "AUTH=Basic %BASIC_B64%"
